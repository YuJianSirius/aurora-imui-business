...
public class ProductViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public ProductViewHolder(View itemView, boolean isSender) {
        super(itemView);
        ...
        mProductImg = (ImageView ) itemView.findViewById(R.id.aurora_custom_product_img);
        mProductNameTv = (TextView) itemView.findViewById(R.id.aurora_custom_product_name);
        mProductPriceTv = (TextView ) itemView.findViewById(R.id.aurora_custom_product_price);
    }
...
//        mMsgTv.setText(message.getText());
        ...
        // product 赋值
        mImageLoader.loadImage(mProductImg, messageExtra.get("productImg"));
        mProductNameTv.setText(messageExtra.get("productName"));
        mProductPriceTv.setText(messageExtra.get("productPrice"));
